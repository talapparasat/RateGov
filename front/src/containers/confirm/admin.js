...
class AdminConfirm extends Component{
    ...
    onPrev=()=>{
        this.props.history.push('/dashboard/admin/connect')
    };
    handleCancel=()=>{
        this.setState({
            visible:false,
                ...
                <Spin spinning={this.state.loading}>
                        ...
                        <div className="add-inner">
                            ...
                            <div className="main-info">
                                <div className="main-info--title">
                                    <p>Общая информация организации</p>
                                    <Link to={'/dashboard/admin/connect'}><Button style={{border:"none",outline:"none"}}><Icon type="edit"/>Редактировать</Button></Link>
                                </div>
                            ...
                            <div style={{width:"100%"}}>
                                <div className="main-info--title">
                                    <p>Общая информация админа</p>
                                    <Link to={'/dashboard/admin/self'}><Button style={{border:"none",outline:"none"}}><Icon type="edit"/>Редактировать</Button></Link>
                                </div>
                                <div style={{borderBottom:"1px solid #e7e7e7"}}>
                                    ...
                                    <h5  className="title-p">{ confirm.User && confirm.User.phone.work ? confirm.User.phone.work.substring(0,2)+'('+confirm.User.phone.work.substring(2,6)+')'+confirm.User.phone.work.substring(6) + ' внутренний: '+ `${ confirm.User.phone.inner}`: null}</h5>
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",padding:"80px 0"}} >
                        <div>
                            ...
                            <span>Шаг 2. Привязать организацию</span>
                        </div>
...
export default connect(mapStateToProps,{getConfirm}) (AdminConfirm);
