...
class OperatorConfirm extends Component{
    ...
    onPrev=()=>{
        this.props.history.push('/dashboard/operator/connect')
    };
    handleError = () => {
        this.setState({
            loading: true,
                        ...
                        <div className="add-inner">
                            ...
                            <div className="main-info">
                                <div className="main-info--title">
                                    ...
                                    <Link to={'/dashboard/operator/connect'}><Button style={{border:"none",outline:"none"}}><Icon type="edit"/>Редактировать</Button></Link>
                                </div>
                            ...
                            <div className="main-info">
                                <div className="main-info--title">
                                    <p>Общая информация услугодателя</p>
                                    <Link to={'/dashboard/operator/connect'}><Button style={{border:"none",outline:"none"}}><Icon type="edit"/>Редактировать</Button></Link>
                                </div>
                                <div>
                            ...
                            <div className="main-info">
                                <div className="main-info--title">
                                    <p>Общая информация оператора</p>
                                    <Link to={'/dashboard/operator/add'}><Button style={{border:"none",outline:"none"}}><Icon type="edit"/>Редактировать</Button></Link>
                                </div>
                                <div>
                                    ...
                                    <h5  className="title-p">{ confirm.User && confirm.User.phone.work ? confirm.User.phone.work.substring(0,2)+'('+confirm.User.phone.work.substring(2,6)+')'+confirm.User.phone.work.substring(6) + ' внутренний: '+ `${ confirm.User.phone.inner}`: 'Неизвестно'}</h5>
