...
class AddOpertor extends Component{
    constructor(){
        super();
        this.state={
            img:'',
    ...
    handleOk=()=>{
        let data={
            ...
            path:'/dashboard/operator/connect'
        }
        if(this.props.user.user[0] && (this.state.img === this.props.user.user[0].image)){
            ...
            data.path = '/dashboard/operator/connect'
                ...
                <Spin spinning={this.state.loading}>
                    ...
                    <div className="container-add">
                        ...
                        <div className="add-inner">
                            <h2 className="h5-title">Шаг 1/2. Добавить оператора</h2>
                            <p className="title-text">Заполните данные нового Оператора.</p>
                                ...
                                <Row gutter={16}>
                                    ...
                                    <Col span={4}>
                                        <Form.Item label="Внутренний">
                                            <Input value={inner} pattern="[0-9]*" onInput={this.handleChangeInput.bind(this)}  name="inner"   placeholder="123"/>
                                        </Form.Item>
                                    </Col>
                                </Row>
                                <Row gutter={16}>
...
export default connect(mapStateToProps,{saveUser,getUserById}) (withRouter(AddOpertor))
